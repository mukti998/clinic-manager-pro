...
import {
  ...
  Home, LogOut, Pill, Shield, Stethoscope, Users, UserPlus, Bell,
} from "lucide-react";
...
function getNavigation(role: string | undefined): NavGroup[] {
  ...
  switch (role) {
    ...
    default:
      return [
        { label: "Main", items: [overview] },
        { label: "Data", items: [{ id: "patients", icon: Users, label: "Patients", to: "/dashboard/patients" }] },
      ];
  }
}
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gradient-mesh bg-dots">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        {/* Top Header */}
        <header className="flex h-14 items-center justify-between border-b border-white/[0.06] bg-background/60 backdrop-blur-xl px-6 shrink-0">
